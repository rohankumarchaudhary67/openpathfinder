export default function SingleMentorCard() {
    return (
        <>
            <div className="items-center bg-gray-50 rounded-lg shadow sm:flex bg-[var(--bg-color)]">
                <a href="#">
                    <img className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg" src="https://www.rcemlearning.org/wp-content/uploads/blank-user-icon-image.jpg" alt="Mentor Image" />
                </a>
                <div className="p-5">
                    <h3 className="text-xl font-bold tracking-tight text-white">
                        <a href="#">Testing Mentor</a>
                    </h3>
                    <span className="text-white">Andoird App Dev</span>
                    <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400"><span className="font-bold">Bio:</span> Lana drives the technical strategy of the flowbite platform and brand.</p>
                    <ul className="flex space-x-4 sm:mt-0">
                        <li>
                            <a href="#" className="hover:text-[var(--primary-color-3)] text-white">
