                        ...
                        <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
                            <div className="mb-12 max-w-[360px] lg:mb-16">
                                <Link href="/" className="mb-4 inline-block">
                                    <div className="flex justify-center items-center">
                                        <Image
                                            ...
                                            className="mr-1"
                                        />
                                        <h1 className="font-bold text-xl md:text-3xl">OpenPathFinder</h1>
                                    </div>
                                </Link>
                                ...
                                <div className="flex items-center">
                                    ...
                                    {/* Github  */}
                                    <a
                                        href="https://github.com/rohankumarchaudhary67/open-pathfinder"
                                        target="_blank"
                                        aria-label="social-link"
                                        className="mr-6 text-[#CED3F6] footer-link"
                                    >
                ...
                <div className="bg-primary/10 py-8">
                    <div className="container">
                        <p className="text-center text-base text-body-color dark:text-white">
                            CopyRights © 2024 - Present Open Path Finder. All rights reserved.
                        </p>
                    </div>
                </div>
                    ...
                    >
                        ...
                        <defs>
                            <linearGradient
                                ...
                                gradientUnits="userSpaceOnUse"
                            >
                                <stop stopColor="#FF204E" stopOpacity="0.62" />
                            ...
                            <linearGradient
                                ...
                                gradientUnits="userSpaceOnUse"
                            >
                                <stop stopColor="#FF204E" stopOpacity="0" />
                                <stop offset="1" stopColor="#FF204E" stopOpacity="0.51" />
                            </linearGradient>
                            <linearGradient
