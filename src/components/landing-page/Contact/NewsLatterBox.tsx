    ...
    return (
        ...
        >
            ...
            <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base font-medium leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
                To get all the detailed updates and launching of any course on your e-mail.
            </p>
            <form>
                <input
                    type="text"
                ...
                <input
                    type="submit"
                    value="Subscribe"
                    className="duration-80 mb-4 w-full cursor-pointer rounded-md border border-transparent bg-[var(--primary-color-2)] py-3 px-6 text-center text-base font-medium text-white outline-none transition ease-in-out hover:bg-opacity-80 hover:shadow-signUp focus-visible:shadow-none"
                />
            ...
            <div className="absolute top-0 left-0 z-[-1]">
                ...
                >
                    ...
                    <defs>
                        ...
                        >
                            <stop stopColor="#FF204E" />
                            <stop offset="1" stopColor="#FF204E" stopOpacity="0" />
                        </linearGradient>
                        <linearGradient
